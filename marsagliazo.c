...
/*
	float rangauss_(void)

	Returns a normally distributed deviate with zero mean and unit variance,
	using ran1real_() as the source of uniform deviates.
	Box and Muller algorithm.
	Source:
		Numerical Recipes in C, p.217
...
float	rangauss_()
	...
	if( iset == 0 )
		/*  we don't have an extra deviate handy, so get two deviates */
		{
		do
			{
